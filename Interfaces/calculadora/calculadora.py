...
# --> pyuic6 -x calculadora.ui -o calculadora.py (convierte de .ui a .py)
# Created by: PyQt6 UI code generator 6.4.2
#
# WARNING: Any manual changes made to this file will be lost when pyuic6 is
# run again.  Do not edit this file unless you know what you are doing.
# este código está subido en bruto desde PyQT y hay que ordenar el código a posteriori


from PyQt6 import QtCore, QtGui, QtWidgets #estas librerías hay que estudiarlas desde la documentación
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        '''aquí usamos lambda y lo que hace es llamar a la función numero_marcado
        al usar los métodos clicked y connect, estos imprimirán el argumento de dicha función
        y repetimos esto en el resto de número (para las teclas de operaciones tenemos que generar sus funciones)'''
    ...
    def numero_marcado(self, numero):
        print(numero)
        '''Esta es la función de la que tiran los botones, y usada para el lambda'''        
        self.lcdNumber.display(numero)
        '''Aquí es donde donde hacemos que muestre el contenido en la calculadora, el método .display, lo que hace es
        que en lugar de mostrar el número en el teminal, lo lleva a la ventana de la calculadora, y y borra el valor anterior
        pero no calcula nada, solo muestra'''
